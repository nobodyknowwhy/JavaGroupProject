...
<body>
	...
	<form method="post">
		...
		<input type="text" name="contact" id="contact" placeholder="phone..." value="">
		<br><br>
		...
		<label for="product">Please Select The Products You Want To Purchase</label>
		...
		<input type="number" name="quantity" id="quantity" min="1" max="0" value="1" disabled>
		<br><br>
